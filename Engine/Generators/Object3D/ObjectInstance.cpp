...
void ObjectInstance::UpdateAnimation()
{
	// アニメーションの更新
...
void ObjectInstance::Draw(Camera* camera, WorldTransform& worldTransform)
{
...
void ObjectInstance::DrawSkeleton(Line& line)
{
	model_->DrawSkeleton(model_->GetSkeleton(), line);
}

void ObjectInstance::CreateMaterialResource()
{
...
void ObjectInstance::CreateCameraResource()
{
...
void ObjectInstance::SetModel(const std::string& filePath, bool isAnimation)
{
	// 拡張子を取り除く処理
...
void ObjectInstance::MaterialByImGui()
{
#ifdef _DEBUG
