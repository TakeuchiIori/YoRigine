...
public:
  ...
  static ImVec4 GetAccentColor() {
    return ImVec4(0.16f, 0.48f, 0.88f, 1.00f);
  } // Tech Blue
  static ImVec4 GetAccentColorDim() {
    return ImVec4(0.16f, 0.48f, 0.88f, 0.30f);
  } // Blue Alpha
  static ImVec4 GetBgDeep() {
    return ImVec4(0.02f, 0.02f, 0.02f, 1.00f);
  } // ほぼ黒
#endif
